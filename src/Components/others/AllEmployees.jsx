...
const AllEmployees = () => {
  ...
  return (
    <div className="bg-[#cac8c8] p-5 mt-2 rounded-sm h-58 font-medium overflow-hidden">
      ...
      <div className="h-[80%] overflow-auto" id="AllEmployees">
        {authData?.userData?.employees?.map((elem, index) => (
          <div
            key={index}
            className="mb-1 py-2 px-4 flex justify-between border border-zinc-400 rounded"
          >
