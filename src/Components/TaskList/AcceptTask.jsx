  ...
  return (
        <div className='flex-shrink-0 h-full w-[300px] p-5 bg-teal-400 rounded-xl'>
            ...
            <div className='flex justify-between mt-4'>
                <button className='bg-orange-400 py-1 capitalize px-2 text-sm rounded cursor-pointer'>mark as Completed</button>
                <button className='bg-red-400 py-1 px-2 capitalize text-sm rounded cursor-pointer'>mark as Failed</button>
            </div>
        </div>
  )
}
